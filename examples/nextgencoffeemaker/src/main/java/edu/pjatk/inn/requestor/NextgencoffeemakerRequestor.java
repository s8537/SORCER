...
import edu.pjatk.inn.nextgencoffeemaker.impl.NextgencoffeeMaker;
import edu.pjatk.inn.nextgencoffeemaker.impl.Inventory;
import edu.pjatk.inn.nextgencoffeemaker.impl.Recipe;
 ...
 */
public class NextgencoffeemakerRequestor {
    private static NextgencoffeeMaker coffeeMaker;
    ...
    public static void main(String[] args) {
	    coffeeMaker = new NextgencoffeeMaker();
	    System.out.println("Welcome to the NextgencoffeeMaker!\n");
	    mainMenu();
	}
}
