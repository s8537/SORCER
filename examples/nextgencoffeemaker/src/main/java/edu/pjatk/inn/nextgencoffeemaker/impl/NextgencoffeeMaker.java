...
import edu.pjatk.inn.nextgencoffeemaker.NextgencoffeeMaking;
 ...
 * @author   Sarah & Mike
 */
public class NextgencoffeeMaker implements NextgencoffeeMaking, NextgencoffeeService {
	private final static Logger logger = LoggerFactory.getLogger(NextgencoffeeMaker.class);
